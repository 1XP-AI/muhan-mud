...
int main(void)
{ return test_normal_and_name_rejection()|test_pre_renew_failure()|test_serializer_failure_and_route_drift()|test_post_publish_outcomes_and_sequential_revision()|test_load_and_reentrant_rejection()|test_stage_observer_forwarding_is_non_authoritative(); }
