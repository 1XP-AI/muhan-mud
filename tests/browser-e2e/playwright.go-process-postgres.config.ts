...
export default defineConfig({
  ...
  webServer: {
    ...
    env: {
      ...
      MUHAN_BROWSER_EXISTING_CHARACTER_NAME: process.env.MUHAN_BROWSER_EXISTING_CHARACTER_NAME ?? "BrowserOld",
      MUHAN_BROWSER_EXISTING_GAME_PASSWORD: process.env.MUHAN_BROWSER_EXISTING_GAME_PASSWORD ?? "existingpw",
    },
  },
});
