...
#define ONBOARDING_CLAIM_ALLOW_WINDOW_SECONDS 90L
...
typedef enum onboarding_control_kind {
    ...
    ONBOARDING_CONTROL_CHALLENGE,
    ONBOARDING_CONTROL_ALLOW,
    ONBOARDING_CONTROL_ACTIVATED,
    ONBOARDING_CONTROL_ACTIVE
