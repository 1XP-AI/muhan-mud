...
uint16_t kind;
{
    ...
    case CDTO_V1_KIND_BANK_SNAPSHOT: return CDTO_V1_BANK_SNAPSHOT_PAYLOAD_LIMIT;
    case CDTO_V1_KIND_ALIAS_TITLE_SNAPSHOT:
        return CDTO_V1_ALIAS_TITLE_SNAPSHOT_PAYLOAD_LIMIT;
    case CDTO_V1_KIND_ALIAS_TITLE_SNAPSHOT_MANIFEST:
        return CDTO_V1_ALIAS_TITLE_SNAPSHOT_MANIFEST_PAYLOAD_LIMIT;
    }
    return 0;
}
