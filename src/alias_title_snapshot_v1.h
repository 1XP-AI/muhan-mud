...
/* Detached, test-only port boundary for the legacy alias/title sidecar.
 * It is deliberately not connected to init_alias(), save_alias(), or a live
 * player.  Values are byte strings to avoid assigning new text semantics. */
