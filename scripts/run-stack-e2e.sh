...
apply_sql "$repo_root/supabase/migrations/20261002000000_legacy_locator_resolver.sql"
apply_sql "$repo_root/supabase/migrations/20261003000000_player_snapshot_v1_inventory_graph_shadow.sql"
apply_sql "$repo_root/supabase/migrations/20261004000000_player_snapshot_v1_full_payload_rehearsal_reader.sql"
apply_sql "$repo_root/supabase/migrations/20261005000000_bank_snapshot_v1_topology_shadow.sql"
apply_sql "$repo_root/supabase/migrations/20261006000000_player_snapshot_normalized_v1_projection_persistence.sql"
apply_sql "$repo_root/supabase/migrations/20261007000000_bank_snapshot_v1_root_value_shadow.sql"
...
apply_sql "$repo_root/supabase/migrations/20261010000000_pending_onboarding_snapshot_eligibility_fulfillment.sql"
apply_sql "$repo_root/supabase/migrations/20261011000000_pending_onboarding_snapshot_eligibility_login.sql"
...
ADMISSION_IDENTITY_PG17_ALLOW_DISPOSABLE=1 \
  pnpm --dir "$repo_root/services/gateway" exec tsx --test \
    ...
    "$repo_root/tests/stack-e2e/local-onboarding-evidence.test.ts" \
