...
impl Kind {
    pub const fn payload_limit(self) -> usize {
        match self {
            ...
            Self::AliasTitleSnapshotManifest => 128 * 1024,
        }
    }
    ...
    fn from_wire(value: u16) -> Result<Self, Error> {
        match value {
            ...
            10 => Ok(Self::AliasTitleSnapshotManifest),
...
pub mod alias_title_snapshot_manifest_v1;
