...
-- The smallest legal CDTO envelope: 16-byte prefix + empty payload + 32-byte digest.
\set pva_payload 'decode(''4d55484344544f000001000700000000e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855'', ''hex'')'
\set pva_snapshot_sha256 ff6b9dc3f41b0c4170f2aa485e2e57c4ce2763198ab273556cf9e8b98c3d23c0
...
select pg_temp.expect_state('P0001', format(
  ...
  :'pva_first_request_sha256', repeat('b', 64), 'player-snapshot-v1', :'pva_snapshot_sha256', :'pva_payload'));
...
select pg_temp.expect_state('22023', format(
  'select * from private.record_player_snapshot_v1_artifact_for_receipt(null::uuid,%L::uuid,%L,%L,9,%L,%L,48,%s)',
  'c9500000-0000-0000-0000-000000000001', :'pva_first_request_sha256', repeat('a', 64), 'player-snapshot-v1', :'pva_snapshot_sha256', :'pva_payload'));
select pg_temp.expect_state('22023', format(
  'select * from private.record_player_snapshot_v1_artifact_for_receipt(%L::uuid,%L::uuid,%L,%L,0,%L,%L,48,%s)',
  'a9500000-0000-0000-0000-000000000001', 'c9500000-0000-0000-0000-000000000001', :'pva_first_request_sha256', repeat('a', 64), 'player-snapshot-v1', :'pva_snapshot_sha256', :'pva_payload'));
select pg_temp.expect_state('22023', format(
  'select * from private.record_player_snapshot_v1_artifact_for_receipt(%L::uuid,%L::uuid,%L,%L,9,%L,%L,47,%s)',
  'a9500000-0000-0000-0000-000000000001', 'c9500000-0000-0000-0000-000000000001', :'pva_first_request_sha256', repeat('a', 64), 'player-snapshot-v1', :'pva_snapshot_sha256', :'pva_payload'));
select pg_temp.expect_state('22023', format(
  'select * from private.record_player_snapshot_v1_artifact_for_receipt(%L::uuid,%L::uuid,%L,%L,9,%L,%L,48,%s)',
  'a9500000-0000-0000-0000-000000000001', 'c9500000-0000-0000-0000-000000000001', :'pva_first_request_sha256', repeat('a', 64), 'wrong-format', :'pva_snapshot_sha256', :'pva_payload'));
select pg_temp.expect_state('22023', format(
  'select * from private.record_player_snapshot_v1_artifact_for_receipt(%L::uuid,%L::uuid,%L,%L,9,%L,%L,48,%s)',
  'a9500000-0000-0000-0000-000000000001', 'c9500000-0000-0000-0000-000000000001', :'pva_first_request_sha256', repeat('a', 64), 'player-snapshot-v1', repeat('c', 64), :'pva_payload'));
select pg_temp.expect_state('22023', format(
...
select pg_temp.expect_state('P0001', format(
  'select * from private.record_player_snapshot_v1_artifact_for_receipt(%L::uuid,%L::uuid,%L,%L,9,%L,%L,48,%s)',
  'a9500000-0000-0000-0000-000000000001', 'c9500000-0000-0000-0000-000000000001', repeat('b', 64), repeat('a', 64), 'player-snapshot-v1', :'pva_snapshot_sha256', :'pva_payload'));
select pg_temp.expect_state('P0001', format(
  'select * from private.record_player_snapshot_v1_artifact_for_receipt(%L::uuid,%L::uuid,%L,%L,9,%L,%L,48,%s)',
  'a9500000-0000-0000-0000-000000000001', 'c9500000-0000-0000-0000-000000000001', :'pva_first_request_sha256', repeat('b', 64), 'player-snapshot-v1', :'pva_snapshot_sha256', :'pva_payload'));
...
select pg_temp.assert_true(
  (select outcome = 'RECORDED' from private.record_player_snapshot_v1_artifact_for_receipt(
    ...
    :'pva_first_request_sha256', repeat('a', 64), 9, 'player-snapshot-v1', :'pva_snapshot_sha256', 48, :pva_payload)),
...
select pg_temp.expect_state('P0001', format(
  'select * from private.record_player_snapshot_v1_artifact_for_receipt(%L::uuid,%L::uuid,%L,%L,10,%L,%L,48,%s)',
  'a9500000-0000-0000-0000-000000000001', 'c9500000-0000-0000-0000-000000000001', :'pva_first_request_sha256', repeat('a', 64), 'player-snapshot-v1', :'pva_snapshot_sha256', :'pva_payload'));
...
select pg_temp.assert_true(
  (select source_post_sha256 = repeat('a', 64)
      ...
      and snapshot_octets = 48 and snapshot_format = 'player-snapshot-v1'
