...
bank_codec_objects=()
for bank_codec in files1 player_record_serializer player_snapshot_v1 object_graph_v1 cdto_v1 bank_snapshot_v1 bank_money_result_native bank_money_command_native bank_money_route; do
