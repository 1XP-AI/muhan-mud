...
create function pg_temp.commit_pair(command uuid,revision bigint,bank bytea default :'bank_payload',player bytea default decode(:'fixture_hex','hex')) returns text language sql as $$
