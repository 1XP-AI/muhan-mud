...
// of players are discarded. This cold-start rule is NOT clear_enm_crt's live
// logout predicate (active NPCs and nonnegative damage in the C runtime).
// Corruption is rejected, never hidden by clearing inconsistent membership.
